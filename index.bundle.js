...
const displayTasks = () => {
    ...
    storageTasks.sort((taskA, taskB) => {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(taskA.date) - (0,date_fns__WEBPACK_IMPORTED_MODULE_10__["default"])(taskB.date) !== 0) {
